...
func NewRouter(dependencies Dependencies) *gin.Engine {
	...
	admin.POST("/evaluation-targets/:target_id/case-tags", dependencies.Catalog.CreateCaseTag)
	admin.POST("/case-tags", dependencies.Catalog.CreateManagedCaseTag)
	...
	admin.PUT("/evaluation-targets/:target_id/case-tags/reorder", dependencies.Catalog.ReorderCaseTags)
